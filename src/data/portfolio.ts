export const portfolio = [
{
  ...
  goal:
    "Budovat důvěryhodný prostor propojující funkci, materiály, klid a promyšlené každodenní prostředí.",
  tags: ["Editorial", "Wellbeing", "Premium"],
},

{
  ...
  goal:
    "Vytvořit prémiový brand svět založený na intimní atmosféře, důvěře a osobním prožitku.",
  tags: ["Editorial", "Luxury", "Wedding"],
},
{
  slug: "petruv-pes",
  title: "Petrův pes",
  ...
  goal:
    "Přenést rodinný přístup, péči a důvěru do současného webového prostředí s důrazem na emoce a přehlednost.",
  tags: ["Branding", "Animals", "Web Design"],
},
{
  ...
  goal:
    "Budovat důvěryhodný a bezpečný prostor podporující hlubší porozumění, vlastní odpovědi a vědomější rozhodování.",
  tags: ["Wellbeing", "Editorial", "Guidance"],
},

{
  ...
  goal:
    "Vytvořit silný digitální svět podporující autenticitu, emoce a rozpoznatelnost interpreta.",
  tags: ["Music", "Cinematic", "Dark"],
},
